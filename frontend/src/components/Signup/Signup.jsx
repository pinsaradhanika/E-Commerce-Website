          ...
          <form className="space-y-6">
            <div>
              ...
              <div className="mt-1" >
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border-gray-700 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm "
                />
              </div>
            </div>
            <div>
            ...
            <div className={`${styles.normalFlex} justify-between`}>
              <div className={`${styles.normalFlex}`}>
                <input
                  ...
                  name="remember-me"
                  id="remember-me"
                  className="h-4 w-4 mt-2 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <label
                  htmlFor="remember-me"
                  className="mt-2 ml-2 block text-sm text-gray-900 "
                >
                  Remember me
                </label>
              </div>
            ...
            <div>
                ...
                <div className="mt-2 flex items-center">
                    ...
                    <label htmlFor="file-input" className="ml-5 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium tex-gray-700 bg-white hover:bg-gray-50">
